...
Overview
--------
A disk utility tool script designed to traverse a given directory, calculate the size of each file and directory within it, 
and convert these sizes into a user-specified unit (KB, MB, GB, or TB).
...
def main() -> None:
    """
    Main function to display the menu and handle user input for the Disk Utility tool.

    The function provides the following options:
    - A. Zip Directories / Files
    - B. Unzip Files
    - C. Analyze Disk Space
    - D. Exit

    It continuously prompts the user to select an option and performs the corresponding action until the user chooses to exit.
    """
    ...
    while program_standby:
        ...
        if menu_choice.lower() == 'a':
            ...
            zip_path = input(
                "Please enter the path of the zip file to unpack: ")
